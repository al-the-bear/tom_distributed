...
// Sources: 9 files
// Generated: 2026-06-17T15:50:41.226734
...
BridgedClass _createCallFrameBridge() {
  return BridgedClass(
    ...
    name: 'CallFrame',
    isAssignable: (v) => v is $tom_dist_ledger_6.CallFrame,
    constructors: {
    ...
    setters: {
      'lastHeartbeat': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.CallFrame>(target, 'CallFrame').lastHeartbeat = D4.extractBridgedArg<DateTime>(value, 'lastHeartbeat'),
      'state': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.CallFrame>(target, 'CallFrame').state = D4.extractBridgedArg<$tom_dist_ledger_6.FrameState>(value, 'state'),
    },
    methods: {
...
BridgedClass _createTempResourceBridge() {
  return BridgedClass(
    ...
    name: 'TempResource',
    isAssignable: (v) => v is $tom_dist_ledger_6.TempResource,
    constructors: {
      '': (visitor, positional, named) {
...
BridgedClass _createLedgerDataBridge() {
  return BridgedClass(
    ...
    name: 'LedgerData',
    isAssignable: (v) => v is $tom_dist_ledger_6.LedgerData,
    constructors: {
      '': (visitor, positional, named) {
    ...
    setters: {
      'aborted': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.LedgerData>(target, 'LedgerData').aborted = D4.extractBridgedArg<bool>(value, 'aborted'),
      'lastHeartbeat': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.LedgerData>(target, 'LedgerData').lastHeartbeat = D4.extractBridgedArg<DateTime>(value, 'lastHeartbeat'),
      'operationState': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.LedgerData>(target, 'LedgerData').operationState = D4.extractBridgedArg<$tom_dist_ledger_6.OperationState>(value, 'operationState'),
      'detectionTimestamp': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.LedgerData>(target, 'LedgerData').detectionTimestamp = D4.extractBridgedArgOrNull<DateTime>(value, 'detectionTimestamp'),
      'removalTimestamp': (visitor, target, value) => 
        D4.validateTarget<$tom_dist_ledger_6.LedgerData>(target, 'LedgerData').removalTimestamp = D4.extractBridgedArgOrNull<DateTime>(value, 'removalTimestamp'),
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
...
BridgedClass _createHeartbeatResultBridge() {
  return BridgedClass(
    ...
    isAssignable: (v) => v is $tom_dist_ledger_6.HeartbeatResult,
    constructors: {
      '': (visitor, positional, named) {
